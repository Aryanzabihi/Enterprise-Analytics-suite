...
class DepartmentRouter:
    ...
    def __init__(self):
        ...
        additional_paths = [
            os.path.join(self.current_dir, 'cs'),  # For cs_metrics_calculator
            os.path.join(self.current_dir, 'pro'), # For metrics_calculator
            os.path.join(self.current_dir, 'hr'),  # For hr_predictive_analytics
            os.path.join(self.current_dir, 'invt'), # For invt_metrics_calculator
            os.path.join(self.current_dir, 'sale'), # For sales_metrics_calculator
            os.path.join(self.current_dir, 'marketing') # For marketing_metrics_calculator
        ]
